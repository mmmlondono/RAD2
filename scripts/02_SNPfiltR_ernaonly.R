####READ ME####
# The purpose of this script is to run SNPfiltR protocol for erna only dataset
...
####Read in files####
#VCF file
vcfR <- read.vcfR("erna/5R.snps.vcf")
...
popmap <- read.csv("erna/popmap_ernaonly.csv")
...
vcfR<-hard_filter(vcfR=vcfR, gq = 30)
vcfR<-hard_filter(vcfR=vcfR, depth = 5)
