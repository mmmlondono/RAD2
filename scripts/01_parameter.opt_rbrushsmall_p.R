...
##Mean depth
var_depth <- read_delim("rbrush/vcf_small/1_sitedepth.ldepth.mean", delim = "\t",
...
a
##Variant missingness
var_miss <- read_delim("rbrush/vcf_small/1_miss_site.lmiss", delim = "\t",
...
##Minor alelle frecuencies
var_freq <- read_delim("rbrush/vcf_small/1_alleles.frq", delim = "\t",
...
##Mean depth per individual
ind_depth <- read_delim("rbrush/vcf_small/1_depth.idepth", delim = "\t",
                        col_names = c("ind", "nsites", "depth"), skip = 1)
d <- ggplot(ind_depth, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d + theme_light()

##Proportion of missing data per individual
ind_miss  <- read_delim("rbrush/vcf_small/1_miss_indiv.imiss", delim = "\t",
                        col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e <- ggplot(ind_miss, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e + theme_light()

####m5 M3 n3####
var_depth1 <- read_delim("rbrush/vcf_small/2_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
...
var_miss1 <- read_delim("rbrush/vcf_small/2_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b1 <- ggplot(var_miss1, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b1 + theme_light()
summary(var_miss1$fmiss)
var_freq1 <- read_delim("rbrush/vcf_small/2_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth1 <- read_delim("rbrush/vcf_small/2_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d1 <- ggplot(ind_depth1, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d1 + theme_light()
ind_miss1  <- read_delim("rbrush/vcf_small/2_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e1 <- ggplot(ind_miss1, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e1 + theme_light()

####m5 M3 n2####
var_depth2 <- read_delim("rbrush/vcf_small/3_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
...
var_miss2 <- read_delim("rbrush/vcf_small/3_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b2 <- ggplot(var_miss2, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b2 + theme_light()
summary(var_miss2$fmiss)
var_freq2 <- read_delim("rbrush/vcf_small/3_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth2 <- read_delim("rbrush/vcf_small/3_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d2 <- ggplot(ind_depth2, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d2 + theme_light()
ind_miss2  <- read_delim("rbrush/vcf_small/3_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e2 <- ggplot(ind_miss2, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e2 + theme_light()
####m7 M3 n3####
var_depth3 <- read_delim("rbrush/vcf_small/4_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
...
var_miss3 <- read_delim("rbrush/vcf_small/4_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b3 <- ggplot(var_miss3, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b3 + theme_light()
summary(var_miss3$fmiss)
var_freq3 <- read_delim("rbrush/vcf_small/4_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth3 <- read_delim("rbrush/vcf_small/4_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d3 <- ggplot(ind_depth3, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d3 + theme_light()
ind_miss3  <- read_delim("rbrush/vcf_small/4_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e3 <- ggplot(ind_miss3, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e3 + theme_light()
####m2 M3 n4####
var_depth4 <- read_delim("rbrush/vcf_small/5_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
...
var_miss4 <- read_delim("rbrush/vcf_small/5_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b4 <- ggplot(var_miss4, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b4 + theme_light()
summary(var_miss4$fmiss)
var_freq4<- read_delim("rbrush/vcf_small/5_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth4 <- read_delim("rbrush/vcf_small/5_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d4 <- ggplot(ind_depth4, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d4 + theme_light()
ind_miss4  <- read_delim("rbrush/vcf_small/5_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e4 <- ggplot(ind_miss4, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e4 + theme_light()

####m7 M5 n7####
var_depth5 <- read_delim("rbrush/vcf_small/6_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
...
var_miss5 <- read_delim("rbrush/vcf_small/6_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b5 <- ggplot(var_miss5, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b5 + theme_light()
summary(var_miss5$fmiss)
var_freq5<- read_delim("rbrush/vcf_small/6_alleles.frq", delim = "\t",
                       col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth5 <- read_delim("rbrush/vcf_small/6_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d5 <- ggplot(ind_depth5, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d5 + theme_light()
ind_miss5  <- read_delim("rbrush/vcf_small/6_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e5 <- ggplot(ind_miss5, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e5 + theme_light()
####plot them all together####
mean_depth <- ggarrange(a, a1, a2, a3, a4, a5,
                        labels = c("m10M5n5", "m5M3n3", "m5M3n2", "m7M3n3", "m2M3n3", "m7M5n7"),
                        ncol = 3, nrow = 2)
variant_missingness <- ggarrange(b, b1, b2, b3, b4, b5,
                                 labels = c("m10M5n5", "m5M3n3", "m5M3n2", "m7M3n3", "m2M3n3", "m7M5n7"),
                                 ncol = 3, nrow = 2)
minor_allele <- ggarrange(c, c1, c2, c3, c4, c5 ,
                          labels = c("m10M5n5", "m5M3n3", "m5M3n2", "m7M3n3", "m2M3n3", "m7M5n7"),
                          ncol = 3, nrow = 2)
depth_indiv <- ggarrange(d, d1, d2, d3, d4, d5,
                         labels = c("m10M5n5", "m5M3n3", "m5M3n2", "m7M3n3", "m2M3n3", "m7M5n7"),
                         ncol = 3, nrow = 2)
missingness_indiv <- ggarrange(e, e1, e2, e3, e4, e5,
                               labels = c("m10M5n5", "m5M3n3", "m5M3n2", "m7M3n3", "m2M3n3", "m7M5n7"),
                               ncol = 3, nrow = 2)
missingness_indiv 
mean_depth
