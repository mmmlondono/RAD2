...
#the more reads that cover a site, the higher confidence our base-call is. 
...
####1####
##Mean depth
var_depth <- read_delim("erna/vcftools/erna1_sitedepth.ldepth.mean", delim = "\t",
...
a
##Variant missingness
var_miss <- read_delim("erna/vcftools/erna1_miss_site.lmiss", delim = "\t",
...
##Minor alelle frecuencies
var_freq <- read_delim("erna/vcftools/erna1_alleles.frq", delim = "\t",
...
##Mean depth per individual
ind_depth <- read_delim("erna/vcftools/erna1_depth.idepth", delim = "\t",
                        col_names = c("ind", "nsites", "depth"), skip = 1)
d <- ggplot(ind_depth, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d + theme_light()

##Proportion of missing data per individual
ind_miss  <- read_delim("erna/vcftools/erna1_miss_indiv.imiss", delim = "\t",
...
var_depth1 <- read_delim("erna/vcftools/erna2_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
...
var_miss1 <- read_delim("erna/vcftools/erna2_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b1 <- ggplot(var_miss1, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b1 + theme_light()
summary(var_miss1$fmiss)
var_freq1 <- read_delim("erna/vcftools/erna2_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth2 <- read_delim("erna/vcftools/erna3_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d2 <- ggplot(ind_depth2, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d2 + theme_light()
ind_miss2  <- read_delim("erna/vcftools/erna3_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e2 <- ggplot(ind_miss2, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e2 + theme_light()

####4####
var_depth3 <- read_delim("erna/vcftools/erna4_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
a3 <- ggplot(var_depth3, aes(mean_depth)) +
  xlim(0, 100)+ geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
a3 + theme_light()
summary(var_depth3$mean_depth)
var_miss3 <- read_delim("erna/vcftools/erna4_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b3 <- ggplot(var_miss3, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b3 + theme_light()
summary(var_miss3$fmiss)
var_freq3 <- read_delim("erna/vcftools/erna4_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth4 <- read_delim("erna/vcftools/erna5_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d4 <- ggplot(ind_depth4, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d4 + theme_light()
ind_miss4  <- read_delim("erna/vcftools/erna5_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e4 <- ggplot(ind_miss4, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e4+ theme_light()

####6####
var_depth5 <- read_delim("erna/vcftools/erna6_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
a5 <- ggplot(var_depth5, aes(mean_depth)) +
  xlim(0, 100)+ geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
a5 + theme_light()
summary(var_depth5$mean_depth)
var_miss5 <- read_delim("erna/vcftools/erna6_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b5 <- ggplot(var_miss5, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b5 + theme_light()
summary(var_miss5$fmiss)
var_freq5 <- read_delim("erna/vcftools/erna6_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth5 <- read_delim("erna/vcftools/erna6_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d5 <- ggplot(ind_depth5, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d5 + theme_light()
ind_miss5  <- read_delim("erna/vcftools/erna6_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e5 <- ggplot(ind_miss5, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e5+ theme_light()

####ref####
var_depth6 <- read_delim("erna/vcftools/referna_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
a6 <- ggplot(var_depth6, aes(mean_depth)) +
  xlim(0, 100)+ geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
a6 + theme_light()

summary(var_depth6$mean_depth)
var_miss6 <- read_delim("erna/vcftools/referna_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b6 <- ggplot(var_miss6, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b6 + theme_light()
summary(var_miss6$fmiss)
var_freq6 <- read_delim("erna/vcftools/referna_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
var_freq6$maf <- var_freq6 %>% select(a1, a2) %>% apply(1, function(z) min(z))
c6<- ggplot(var_freq6, aes(maf)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
c6 + theme_light()
summary(var_freq6$maf)
ind_depth6 <- read_delim("erna/vcftools/referna_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d6 <- ggplot(ind_depth6, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d6 + theme_light()
ind_miss6  <- read_delim("erna/vcftools/referna_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e6 <- ggplot(ind_miss6, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e6+ theme_light()

####6R####
var_depth7 <- read_delim("erna/vcftools/erna6R_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
a7 <- ggplot(var_depth7, aes(mean_depth)) +
  xlim(0, 100)+ geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
a7 + theme_light()
summary(var_depth7$mean_depth)
var_miss7 <- read_delim("erna/vcftools/erna6R_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b7 <- ggplot(var_miss7, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b7 + theme_light()
summary(var_miss7$fmiss)
var_freq7 <- read_delim("erna/vcftools/erna6R_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
var_freq7$maf <- var_freq7 %>% select(a1, a2) %>% apply(1, function(z) min(z))
c7<- ggplot(var_freq7, aes(maf)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
c7 + theme_light()
summary(var_freq7$maf)
ind_depth7 <- read_delim("erna/vcftools/erna6R_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d7 <- ggplot(ind_depth7, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d7 + theme_light()
ind_miss7  <- read_delim("erna/vcftools/erna6R_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e7 <- ggplot(ind_miss7, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e7+ theme_light()

####plot them all together####
mean_depth <- ggarrange(a, a1, a2, a3, a4, a5, a6, a7,
                        labels = c("1", "2", "3", "4", "5", "6", "ref", "6R"),
                        ncol = 3, nrow = 3)
variant_missingness <- ggarrange(b, b1, b2, b3, b4, b5, b6, b7,
                                 labels = c("1", "2", "3", "4", "5", "6", "ref", "6R"),
                                 ncol = 3, nrow = 3)
minor_allele <- ggarrange(c, c1, c2, c3, c4, c5, c6, c7,
                          labels = c("1", "2", "3", "4", "5", "6", "ref", "6R"),
                          ncol = 3, nrow = 3)
depth_indiv <- ggarrange(d, d1, d2, d3, d4, d5, d6, d7,
                         labels = c("1", "2", "3", "4", "5", "6", "ref", "6R"),
                         ncol = 3, nrow = 3)
missingness_indiv <- ggarrange(e, e1, e2, e3, e4, e5, e6, e7,
                               labels = c("1", "2", "3", "4", "5", "6", "ref", "6R"),
                               ncol = 3, nrow = 3)
