...
####Wolbachia####
##Mean depth
var_depth <- read_delim("wolbachia/vcf/wol_sitedepth.ldepth.mean", delim = "\t",
...
a
##Variant missingness
var_miss <- read_delim("wolbachia/vcf/wol_miss_site.lmiss", delim = "\t",
...
##Minor alelle frecuencies
var_freq <- read_delim("wolbachia/vcf/wol_alleles.frq", delim = "\t",
...
##Mean depth per individual
ind_depth <- read_delim("wolbachia/vcf/wol_depth.idepth", delim = "\t",
                        col_names = c("ind", "nsites", "depth"), skip = 1)
d <- ggplot(ind_depth, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d + theme_light()

##Proportion of missing data per individual
ind_miss  <- read_delim("wolbachia/vcf/wol_miss_indiv.imiss", delim = "\t",
...
var_miss1 <- read_delim("wolbachia/vcf/wolo_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b1 <- ggplot(var_miss1, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b1 + theme_light()
summary(var_miss1$fmiss)
var_freq1 <- read_delim("wolbachia/vcf/wolo_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth1 <- read_delim("wolbachia/vcf/wolo_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d1 <- ggplot(ind_depth1, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d1 + theme_light()
ind_miss1  <- read_delim("wolbachia/vcf/wolo_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
...
####filtered####
var_depth2 <- read_delim("wolbachia/vcf/wolf_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
a2 <- ggplot(var_depth2, aes(mean_depth)) +
  xlim(0, 100)+ geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
a2 + theme_light()
summary(var_depth2$mean_depth)
var_miss2 <- read_delim("wolbachia/vcf/wolf_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
b2 <- ggplot(var_miss2, aes(fmiss)) + geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
b2 + theme_light()
summary(var_miss2$fmiss)
var_freq2 <- read_delim("wolbachia/vcf/wolf_alleles.frq", delim = "\t",
                        col_names = c("chr", "pos", "nalleles", "nchr", "a1", "a2"), skip = 1)
...
ind_depth2 <- read_delim("wolbachia/vcf/wolf_depth.idepth", delim = "\t",
                         col_names = c("ind", "nsites", "depth"), skip = 1)
d2 <- ggplot(ind_depth2, aes(depth)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
d2 + theme_light()
ind_miss2  <- read_delim("wolbachia/vcf/wolf_miss_indiv.imiss", delim = "\t",
                         col_names = c("ind", "ndata", "nfiltered", "nmiss", "fmiss"), skip = 1)
e2 <- ggplot(ind_miss2, aes(fmiss)) + geom_histogram(fill = "dodgerblue1", colour = "black", alpha = 0.3)
e2 + theme_light()

####No R####
var_depth3 <- read_delim("wolbachia/vcf/wolR_sitedepth.ldepth.mean", delim = "\t",
                         col_names = c("chr", "pos", "mean_depth", "var_depth"), skip =1)
a3 <- ggplot(var_depth3, aes(mean_depth)) +
  xlim(0, 100)+ geom_density(fill = "dodgerblue1", colour = "black", alpha = 0.3)
a3 + theme_light()
summary(var_depth3$mean_depth)
var_miss3 <- read_delim("wolbachia/vcf/wolR_miss_site.lmiss", delim = "\t",
                        col_names = c("chr", "pos", "nchr", "nfiltered", "nmiss","fmiss"), skip = 1)
