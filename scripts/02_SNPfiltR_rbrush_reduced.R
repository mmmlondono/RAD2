####READ ME####
# The purpose of this script is to run SNPfiltR protocol for the reduced dataset for rabitbrush
####libraries####
library(SNPfiltR)
library(devtools)
...
####Read in files####
#VCF file
vcfR <- read.vcfR("rbrush/vcf/populationsR.snps.vcf")
